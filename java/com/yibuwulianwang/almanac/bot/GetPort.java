...
public class GetPort {
	...
	static {
		...
		try {
			propt_lat.load(GetPort.class.getClassLoader().getResourceAsStream("com/yibuwulianwang/almanac/bot/latport.properties"));
			propt_loog.load(GetPort.class.getClassLoader().getResourceAsStream("com/yibuwulianwang/almanac/bot/loogport.properties"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
